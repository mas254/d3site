...
### Reshaping the data using the reshape2 package (check explanation of ifelse and recode is clear as well)

To move from the 'wide' to the 'long' format we can also use the functions **melt** and **dcast**, from the **reshape2** package. The **melt** function is roughy equivalent to **gather** and the **dcast** function is roughy equivalent to **spread**.
